...
class Menu extends Component {
  ...
  Priceminus = (e) => {
    ...
    this.setState({
      finalAmount:
        this.state.HamburgerPrice +
        this.state.PepsiPrice +
        this.state.friesPrice +
        this.state.CokePrice +
        this.state.SandwichPrice +
  ...
  render() {
    return (
      <MenuComponent
        refreshCart={this.cartChange}
        Priceplus={this.Priceplus}
        Priceminus={this.Priceminus}
        state={this.state}
      />
    );
  }
